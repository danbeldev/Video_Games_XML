package com.madproject.feature_main.screens.feedScreen
...
import com.madproject.feature_main.databinding.FragmentFeedBinding
import com.madproject.feature_main.di.MainComponentViewModel
import com.madproject.feature_main.screens.feedScreen.adapter.CreatorsAdapter
import com.madproject.feature_main.screens.feedScreen.adapter.PlatformsAdapter
import com.madproject.feature_main.screens.feedScreen.adapter.StoresAdapter
import com.madproject.feature_main.screens.feedScreen.adapter.TagsAdapter
import com.madproject.feature_main.screens.feedScreen.adapter.VideoGamesHorizontalAdapter
import com.madproject.feature_main.screens.feedScreen.viewModel.FeedViewModel
import dagger.Lazy
...
class FeedFragment:Fragment(R.layout.fragment_feed) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.adsTextButton.setOnClickListener {
            navigation(
                NavCommand(
                    NavCommands.DeepLink(
                        url = Uri.parse(Screen.Compose.route),
                        isModal = true,
                        isSingleTop = false
                    )
                )
