package com.madproject.videogames.data.utils.model

import com.google.firebase.database.DataSnapshot

enum class UtilsAdsType {
    YANDEX,
    MY_TARGET,
    STORT
}
...
data class Utils(
    ...
    val info: String,
    val adsType: UtilsAdsType,
    val my_target_rewarded_yandex_ads_id: String,
    val my_target_interstitial_yandex_ads_id: String,
    val my_target_banner_yandex_ads_id: String,
    val stort_id: String
)
...
fun DataSnapshot.mapUtils(): Utils {
    return Utils(
        ...
        my_target_rewarded_yandex_ads_id = child("my_target_rewarded_yandex_ads_id").value.toString(),
        my_target_interstitial_yandex_ads_id = child("my_target_interstitial_yandex_ads_id").value.toString(),
        my_target_banner_yandex_ads_id = child("my_target_banner_yandex_ads_id").value.toString(),
        stort_id = child("stort_id").value.toString(),
        ...
        adsType = enumValueOf(child("adsType").value.toString())
    )
}