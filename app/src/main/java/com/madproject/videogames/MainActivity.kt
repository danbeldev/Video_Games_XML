...
import com.madproject.core_common.naigation.NavigationProvider
import com.madproject.core_ui.R

class MainActivity : AppCompatActivity(), NavigationProvider {

    private val navController:NavController
        get() = findNavController(com.madproject.videogames.R.id.containerView)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(com.madproject.videogames.R.layout.activity_main)
    }
    ...
    private fun openDeepLink(url:Uri, isModal:Boolean, isSingleTop: Boolean){
        val navOption = if (isModal){
            NavOptions.Builder()
                ...
                .setPopUpTo(if (isSingleTop) com.madproject.videogames.R.id.nav_graph_application_xml else -1
            ...
            NavOptions.Builder()
                ...
                .setLaunchSingleTop(isSingleTop)
                .setPopUpTo(if (isSingleTop) com.madproject.videogames.R.id.nav_graph_application_xml else
